...
from utils.other_prompts import bio_s1_prompt_demonstration, bio_s2_edit_prompt_demonstration

class bio:
    def __init__(self):
        # load data
        with open("datasets/mmlu/mmlu_bio_simplified.json", "r") as f:
            self.data = json.load(f)
        
        # s1_prompt
        self.s1_prompt_demonstration = bio_s1_prompt_demonstration
        
        # s2_edit_prompt
        self.s2_edit_prompt_demonstration = bio_s2_edit_prompt_demonstration
        
    def get_dataset(self):
        return self.data
    
    def get_question(self, data_point):
        opa, opb, opc, opd = data_point["options"]
        return data_point["question"] + " A: " + str(opa) + " B: " + str(opb) + " C: " + str(opc) + " D: " + str(opd)
