...
from utils.other_prompts import phy_s1_prompt_demonstration, phy_s2_edit_prompt_demonstration

class phy:
    def __init__(self):
        # load data
        with open("datasets/mmlu/mmlu_phy.json", "r") as f:
            self.data = json.load(f)
        
        # s1_prompt
        self.s1_prompt_demonstration = phy_s1_prompt_demonstration
        
        # s2_edit_prompt
        self.s2_edit_prompt_demonstration = phy_s2_edit_prompt_demonstration
